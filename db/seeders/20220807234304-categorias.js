  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          id_cat: 'b2b54c0a-358c-4d85-bce5-50a2df397425',
        ...
        {
          id_cat: 'b8bed901-09c1-4f77-8bf7-b89d14531663',
          nombre_cat: 'Llantas',
        ...
        {
          id_cat: '8782dedb-1bf8-4370-897e-6ff8abd1ad66',
          nombre_cat: 'Aros',
        ...
        {
          id_cat: 'aa440cd4-c073-4ff1-971a-40003bdd3194',
          nombre_cat: 'Accesorios',
          desc_cat: 'Todo tipo de accesorios para vehículos',
          estado_cat: 1
        },
        {
          id_cat: 'cd2903ff-0dcf-4cce-a7ea-bf4e02e84e84',
          nombre_cat: 'Filtros',
          desc_cat: 'Todo tipo de filtros para motor',
          estado_cat: 1
        },
        {
          id_cat: '82038ae3-f00b-44e4-876c-03c49caec682',
